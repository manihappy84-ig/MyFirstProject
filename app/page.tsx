...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Add customized diagonal text watermarks or security stamps to your PDF files instantly.',
    href: '/tools/create-watermark',
      ...
      <header className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-4 hover:opacity-90 transition">
            <span className="text-4xl font-black text-rose-500 tracking-tight">OCR</span>
            <div className="flex flex-col">
              <span className="text-3xl font-bold text-white tracking-tight leading-none">InfyGalaxy</span>
              <span className="text-xs font-bold text-rose-400 tracking-widest mt-1.5 leading-none">SHAPING AI TOOLS</span>
            </div>
          </a>
